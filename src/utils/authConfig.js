...
// const clientId = 'fbb0db68-3d70-4fe8-bfd7-35f409da6fdb';
const clientId = process.env.NEXT_PUBLIC_CLIENT_ID;
const tenantName = process.env.NEXT_PUBLIC_TENANT_NAME;

const flows = {
    localAccSignIn:process.env.NEXT_PUBLIC_LOCAL_ACC_SIGN_IN, //e.g., B2C_1_main_flow
    // msid: 'B2C_1_msid',
}
...
export const protectedResources = {
    todoListApi: {
      endpoint: "https://localhost:7123",
      scopes: ["https://TestHLClientsb2c.onmicrosoft.com/task-api/tasks.read"],
    },
  }
...
export const msalConfig = {
    auth: {
        ...
        redirectUri: process.env.NEXT_PUBLIC_APP_URL, // You must register this URI on Azure Portal/App Registration. Defaults to window.location.origin
        postLogoutRedirectUri: process.env.NEXT_PUBLIC_APP_URL, // Indicates the page to navigate after logout.
